    ...
    <div id="resultsScreen" className="text-center space-y-6">
      <div className="bg-stone-900 border border-stone-900 rounded-2xl p-8">
        ...
        <p className="text-xl text-stone-300 mb-6">
          Your Score: <span id="finalScore" className="text-bone font-bold">{score}/{total} ({percentage}%)</span>
        </p>
        ...
        <div className="mb-6 text-left">
          ...
          <div id="performanceStats" className="space-y-2 text-sm">
            ...
            <div className="flex justify-between text-stone-300">
              <span className="flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" className="size-4 text-bone" strokeWidth={1.5} stroke="currentColor">
        ...
        <div className="grid grid-cols-3 gap-2 mt-2">
          <button onClick={onRetake} className="bg-stone-900 hover:bg-stone-800 border border-stone-900 hover:border-stone-800 text-stone-200 hover:text-white rounded-xl px-3 py-3 text-sm font-medium transition-all duration-300 flex flex-col items-center justify-center gap-1.5">
          ...
          <button onClick={onReview} className="bg-stone-900 hover:bg-stone-800 border border-stone-900 hover:border-stone-800 text-stone-200 hover:text-white rounded-xl px-3 py-3 text-sm font-medium transition-all duration-300 flex flex-col items-center justify-center gap-1.5">
            <svg xmlns="http://www.w3.org/2000/svg" className="size-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
          ...
          <button onClick={onNewTopic} className="bg-stone-900 hover:bg-stone-800 border border-stone-900 hover:border-stone-800 text-stone-200 hover:text-white rounded-xl px-3 py-3 text-sm font-medium transition-all duration-300 flex flex-col items-center justify-center gap-1.5">
